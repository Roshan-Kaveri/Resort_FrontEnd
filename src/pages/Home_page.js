...
function Home_page() {
    ...
    style={{ textAlign: 'center', padding: '10px', fontStyle: 'italic', fontWeight: 'bold', fontSize: '20px' }}
       ></textarea>
                        ...
                        <h2 className="RoomBook" onClick={() => navigate("/RoomBook", { state: { resort_id: resort_id } })}>
                            <b> Book A Room Now!</b>
                        </h2>
                    </div>
                </div>
                <div className="Hrectangle2">
                    <div className='Hc2'>
                        ...
                        <h2 className="Cabservice" onClick={() => navigate("/cab", { state: { resort_id: resort_id } })}>
                            <b> Book A Cab Now!</b>
                        </h2>
                    </div>
                </div>
...
></textarea>
                        ...
                        <h2 className="FoodOrder" onClick={() => navigate("/Food", { state: { resort_id: resort_id } })}>
                            <b>Order Now!</b>
                        </h2>
                    </div>
                </div>
